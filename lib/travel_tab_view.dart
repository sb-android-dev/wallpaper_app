...
class TravelTabView extends StatelessWidget {
  TravelTabView({Key? key, required this.loadMoreCallback, required this.refreshCallback}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<TravelBloc, PhotosState>(builder: (context, state) {
